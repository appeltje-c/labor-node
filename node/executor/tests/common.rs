...
pub fn compact_code_unwrap() -> &'static [u8] {
	labor_node_runtime::WASM_BINARY.expect("Development wasm binary is not available. \
									  Testing is only supported with the flag disabled.")
}

pub const GENESIS_HASH: [u8; 32] = [69u8; 32];

pub const SPEC_VERSION: u32 = labor_node_runtime::VERSION.spec_version;

pub const TRANSACTION_VERSION: u32 = labor_node_runtime::VERSION.transaction_version;
